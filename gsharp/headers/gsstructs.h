...
// create instance of ToneTable
struct ToneTable {
		ToneTable() {};
		~ToneTable() {};	// to relate the tone letter value to the tone numerical value
...
// do I have the ability here to instantiate separate ToneTables according to key?
		short int GS1 = 10, \
...
// I can increment the fretBoard to CALCULATE the values of tones and chords per key's location (+/-) with respect to G#
